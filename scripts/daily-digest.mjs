...
const SECTIONS = [
  ...
  {
    title: '🚀 PH & SEA Startups & Business',
    windowHours: 48,
    maxItems: 6,
    maxPerFeed: 2,
    feeds: [
      ...
      { name: 'GMA Money', url: 'https://data.gmanetwork.com/gno/rss/money/feed.xml' },
    ],
  },
  {
    ...
    feeds: [
      ...
      { name: 'Guardian Wellness', url: 'https://www.theguardian.com/lifeandstyle/health-and-wellbeing/rss' },
      { name: 'NYT Well', url: 'https://rss.nytimes.com/services/xml/rss/nyt/Well.xml' },
    ],
  },
  {
    title: '✨ Trends — Social, Design & Culture',
    windowHours: 48,
    maxItems: 7,
    // One per source so TikTok/IG, design, music, and PH culture all get a slot.
    maxPerFeed: 1,
    feeds: [
      ...
      { name: 'Nolisoli', url: 'https://nolisoli.ph/feed/' },
      { name: 'When in Manila', url: 'https://www.wheninmanila.com/feed/' },
    ],
  },
  {
    title: '🏆 Sports',
    ...
    feeds: [
      ...
      { name: 'Rappler Sports', url: 'https://www.rappler.com/sports/feed/' },
    ],
  },
];
